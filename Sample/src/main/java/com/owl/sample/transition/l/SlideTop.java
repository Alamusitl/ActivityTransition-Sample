...
public class SlideTop extends BaseActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        getWindow().setEnterTransition(mSlideTop);
        getWindow().setExitTransition(mSlideTop);
        getWindow().setReenterTransition(mSlideTop);

        setContentView(R.layout.activity_explode);
        mTextView.setText("Slide Top");
    }
}
